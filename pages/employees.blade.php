...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-12 container-fluid" style="margin-top: -30px;">
            <ul class="nav nav-tabs" style="margin-top: 70px;">
                <li class="active"><a href="#sltablediv" style="color: #555;">Employees Forms Data</a></li>
            </ul>
            <div class="tab-content">
                <div id="sltablediv" class="tab-pane fade in active">
                    <h1 align="center" {{-- style="margin-top: 70px;" --}}>Employees Forms Data</h1>
                    <table class="table table-bordered" id="sltable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->SALARY}}</td>
                                <td>{{$row->ADDRESS}}</td>
                                <td style="text-align: center;"><i class="fa fa-pencil-square-o" aria-hidden="true" style="cursor: pointer;" onclick="document.getElementById('id01{{$row->EMPLOYEE_ID}}').style.display='block'"></i></td>
                                <td style="text-align: center;"><i class="fa fa-trash-o" aria-hidden="true" style="cursor: pointer; color: red;" onclick="document.getElementById('id02{{$row->EMPLOYEE_ID}}').style.display='block'"></i></td>
                            </tr>
                            <div id="id01{{$row->EMPLOYEE_ID}}" class="modal slmodal">
                                <div class="modal-content animate" name="slmodal">
                                    <form method="post" action="{{url('EmployeesUpdate')}}" role="form" id="sldata">
                                        {{csrf_field()}}
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="SALARY" type="number" name="SALARY" class="form-control" placeholder="Please enter your salary *" required="required" data-error="Valid Salary is required." value="{{$row->SALARY}}">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                            ...
                            <div id="id02{{$row->EMPLOYEE_ID}}" class="modal">
                                <div class="modal-content animate modal-sm">
                                    <form method="post" action="{{url('EmployeesDestroy')}}" role="form" id="sldata">
                                        {{csrf_field()}}
                                            ...
                                            <div class="container-fluid" style="background-color:#f1f1f1; padding: 16px;">
                                                <div class="" style="float: left;">
                                                    <button type="button" onclick="document.getElementById('id02{{$row->EMPLOYEE_ID}}').style.display='none'" class="cancelbtn">Cancel</button>
                                                </div>
 ...
 <thead>
                            <tr>
                                <th  style="text-align: center;"><i class="fa fa-plus-circle" aria-hidden="true" style="cursor: pointer; color: orange;" onclick="document.getElementById('id03{{$row->EMPLOYEE_ID}}').style.display='block'"></i></th>
                            </tr>
                        </thead>

                        <div id="id03{{$row->EMPLOYEE_ID}}" class="modal slmodal">
                                <div class="modal-content animate" name="slmodal">
                                    <form method="post" action="{{url('EmployeesAdd')}}" role="form" id="sldata">
                                        {{csrf_field()}}
                                        <div class="container" style="padding: 16px;">
                                            <div class="row">
                                                <div class="col-sm-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="form_message">Salary</label>
                                                        <input id="SALARY" name="SALARY" class="form-control" placeholder="Please enter your salary" required="required"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="form_message">Address</label>
                                                        <input id="ADDRESS" type="text" name="ADDRESS" class="form-control" placeholder="Please enter your address *" required="required" data-error="Valid address is required.">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="container col-md-12" style="background-color:#f1f1f1; padding: 16px;">
                                            <div class="col-md-4" style="float: left;">
                                                <button type="button" onclick="document.getElementById('id03{{$row->EMPLOYEE_ID}}').style.display='none'" class="cancelbtn">Cancel</button>
                                            </div>
