                    ...
                    <table class="table table-bordered" id="sltable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><i id="editart" class="fa fa-pencil-square-o editart" data-article_id="{{$row->ARTICLE_ID}}" data-date="{{$row->DATE }}" data-title="{{$row->TITLE}}" data-document="{{$row->DOCUMENT}}" data-image="{{$row->IMAGE}}" aria-hidden="true" style="cursor: pointer;"></i></td>
                                <td style="text-align: center;"><i id="delart" class="fa fa-trash-o delart" data-article_id="{{$row->ARTICLE_ID}}" data-date="{{$row->DATE }}" data-title="{{$row->TITLE}}" data-document="{{$row->DOCUMENT}}" data-image="{{$row->IMAGE}}" aria-hidden="true" style="cursor: pointer; color: red;"></i></td>
                            </tr>
                    ...
                    <div class="hidden"><input type="text" name="ID8" id="ID8"></div>
                                    <form method="post" action="ArticlesUpdate" role="form" id="sldata">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="TITLE1" name="TITLE1" class="form-control"  maxlength ="100" placeholder="Write Title.." rows="5">{{$row->TITLE}}</textarea>
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="DOCUMENT1" name="DOCUMENT1" class="form-control" placeholder="Write Αrticle.." rows="5">{{$row->DOCUMENT}}</textarea>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="IMAGE1" type="file" name="IMAGE1" class="form-control" placeholder="Browse image*">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input name="ARTICLE_ID1" id="ARTICLE_ID1" class="hidden ID" value="{{$row->ARTICLE_ID}}">
                                            <input name="DATE1" id="DATE1" class="hidden ID" value="{{$row->DATE}}">
                                            <input name="IMAGE1" id="IMAGE1" class="hidden ID" value="{{$row->IMAGE}}">
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <form class="form-horizontal" role="form" method="post" action="ArticlesDestroy">
	                    ...
	                    <div class="row">
                            ...
                            @endforeach
                                <thead>
                            <tr>
                                <th  style="text-align: center;"><i id="addart" class="fa fa-plus-circle addart" aria-hidden="true" style="cursor: pointer; color: orange;" onclick="document.getElementById('id03{{$row->ARTICLE_ID}}').style.display='block'"></i></th>
                            </tr>
                        <!-- </thead>
                                    ...
                                    <form method="post" action="ArticlesAdd" role="form" id="sldata">
                                        ...
                                        <div class="container" style="padding: 16px;">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input name="ID" id = "ID" class="hidden ID" value="{{$row->ARTICLE_ID}}">   
                                        </div>
                                    </form>
                                </div>
                            </div>
